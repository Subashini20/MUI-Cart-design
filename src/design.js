...
export default function BasicCard() {
  ...
  return (
    ...
    <Card sx={{width:'1310px', height:'540px',backgroundImage: 'linear-gradient(to right, #0062E6 , #33AEFF)', padding: '3%', marginLeft:'0%',display:'flex', gap:'25px',overflowX:'none'}}>
       
     <Card sx={{ width: 350, height: 540, marginLeft:'60px' ,borderRadius:'25px',transition:'0.5s ease-in-out','&:hover':{transform:'translateY(-10px)',boxShadow:'-5px 0 10px -5px rgba(0,0,0,0.5), 5px 0 10px -5px rgba(0,0,0,0.5)',Button:{opacity:'1',}},}}>
      <CardContent>
    ...
    <Card sx={{ width: 350, height: 540, marginLeft: 0,borderRadius:'25px',transition:'0.5s ease-in-out','&:hover':{transform:'translateY(-10px)',boxShadow:'-5px 0 10px -5px rgba(0,0,0,0.5), 5px 0 10px -5px rgba(0,0,0,0.5)',Button:{opacity:'1',},}}}>
      <CardContent>
        <Typography sx={{ fontSize: 14, fontWeight:700}} color="#989FA4"  gutterBottom>
          PLUS
        </Typography>
